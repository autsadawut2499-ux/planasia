...
export function useStoreBrowseOptional() {
  return useContext(StoreBrowseContext);
}

/** Matches listing against search query (plan code/ID, name, style, slug, description). */
