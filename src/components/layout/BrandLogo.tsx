...
export function BrandLogo({
  ...
  const wordmarkClass = `font-brand whitespace-nowrap text-[15px] font-semibold uppercase leading-none tracking-[0.12em] sm:text-[17px] sm:tracking-[0.16em] md:text-[19px] md:tracking-[0.18em] ${textClass}`;
