...
export const REFUND_CONTENT: LegalContentMap = {
  ...
  th: {
    ...
    sections: [
      {
        heading: "1.1 ไม่รับคืนหลังเข้าสู่กระบวนการพิมพ์",
        body: "เนื่องจากสินค้าเป็นงานพิมพ์และเข้าเล่มตามคำสั่งซื้อ (Made to order) จึงไม่สามารถเปลี่ยนหรือคืนเงินได้เมื่อเข้าสู่กระบวนการพิมพ์แล้ว โปรดตรวจสอบตัวเลือกและข้อมูลให้ถูกต้องก่อนสั่งซื้อ",
      },
      {
        heading: "1.2 ลักษณะสินค้า (Made to order)",
        body: "สินค้าหลักบนแพลตฟอร์ม Planasia เป็นชุดเอกสารแบบพิมพ์เขียวรูปเล่ม PDF (และแพ็กเกจเสริมที่เกี่ยวข้อง) ซึ่งพิมพ์และเข้าเล่มตามคำสั่งซื้อของลูกค้าแต่ละราย เอกสารรูปเล่มไม่สามารถ \"ส่งคืน\" ได้ในลักษณะเดียวกับสินค้าทางกายภาพทั่วไป หลังจากดำเนินการพิมพ์และเข้าเล่มแล้วไม่สามารถยกเลิกหรือคืนเงินได้",
      },
      {
        heading: "1.3 กรณีสินค้าชำรุดเสียหายจากการขนส่ง (ไม่ใช่การคืนสินค้า)",
        body: "หากท่านได้รับชุดเอกสารแล้วพบว่าชำรุดหรือเสียหายจากการขนส่ง กรุณาติดต่อ hello@planasia.com พร้อมเลขอ้างอิงคำสั่งซื้อ หลักฐานการชำระเงิน และรูปถ่ายสภาพสินค้า เราจะตรวจสอบและจัดส่งชุดเอกสารใหม่ให้ตามความเหมาะสม การจัดส่งใหม่เป็นการแก้ไขปัญหาด้านสินค้าเสียหาย — ไม่ใช่การคืนสินค้าเพื่อขอเครดิตหรือคืนเงินตามนโยบายนี้",
      },
      {
...
export const SHIPPING_CONTENT: LegalContentMap = {
  ...
  th: {
    ...
    sections: [
      {
        heading: "4.1 ขอบเขต",
        body: "สินค้าบนแพลตฟอร์ม Planasia ประกอบด้วยชุดเอกสารแบบพิมพ์เขียวรูปเล่ม PDF และบริการเสริมตามเงื่อนไขที่ลูกค้าเลือกในขั้นตอนการสั่งซื้อ นโยบายการจัดส่งสินค้าฉบับนี้อธิบายวิธีการจัดส่งชุดเอกสารหลัก และชุดเอกสารเสริม (หากมีการเลือก) หลังการชำระเงินสำเร็จ",
      },
      {
        heading: "4.2 การจัดส่งชุดเอกสารหลัก",
        body: "สินค้าหลักคือชุดแบบพิมพ์เขียวรูปเล่ม PDF จำนวน 3 ชุด สำหรับนำไปยื่นขออนุญาตก่อสร้าง หลังชำระเงินสำเร็จ ทางเราจะดำเนินการพิมพ์ เข้าเล่ม และจัดส่งชุดเอกสารไปยังที่อยู่ของท่านโดยไปรษณีย์/ขนส่ง ระยะเวลาจัดส่งโดยประมาณ 2-3 วันทำการ (อาจเปลี่ยนแปลงตามพื้นที่และผู้ให้บริการขนส่ง) ท่านจะได้รับอีเมลยืนยันการจัดส่งพร้อมเลขอ้างอิงคำสั่งซื้อ",
      },
      {
        heading: "4.3 เงื่อนไขการจัดส่งชุดเอกสารเพิ่มเติม",
        body: "หากท่านสั่งซื้อชุดเอกสารเพิ่มเติมนอกเหนือจากชุดหลัก ทางเราจะดำเนินการพิมพ์ เข้าเล่ม และจัดส่งตามเงื่อนไขและช่องทางที่ได้ตกลงกันไว้ โดยคิดค่าบริการตามจำนวนชุดและที่อยู่จัดส่ง ชุดเพิ่มเติมไม่ได้รวมอยู่ในทุกคำสั่งซื้อโดยอัตโนมัติ จะมีผลเฉพาะเมื่อท่านเลือกหรือยืนยันเป็นส่วนหนึ่งของการซื้อ",
      },
      {
        heading: "4.4 ระยะเวลาในการดำเนินการ",
        body: "หลังการชำระเงินสำเร็จ ทีมงานจะดำเนินการพิมพ์ เข้าเล่ม และจัดเตรียมชุดเอกสารภายใน 1-2 วันทำการ จากนั้นจัดส่งโดยไปรษณีย์/ขนส่ง ระยะเวลาจัดส่งรวมประมาณ 2-3 วันทำการ (อาจเปลี่ยนแปลงตามพื้นที่ ผู้ให้บริการขนส่ง หรือช่วงวันหยุด) ท่านจะได้รับอีเมลแจ้งสถานะการจัดส่งเมื่อชุดเอกสารอยู่ระหว่างการนำส่ง",
      },
      {
        heading: "4.5 ปัญหาการจัดส่งหรือการรับสินค้า",
        body: "หากท่านไม่ได้รับชุดเอกสารภายใน 7 วันทำการ หรือสินค้าได้รับความเสียหายจากการขนส่ง กรุณาติดต่อทีมสนับสนุนของเราได้ตลอดเวลาผ่านช่องทางติดต่อบนเว็บไซต์ พร้อมระบุเลขอ้างอิงคำสั่งซื้อและหลักฐานการชำระเงิน เพื่อให้เราตรวจสอบและช่วยเหลือท่านอย่างรวดเร็ว กรณีสินค้าเสียหายจากการขนส่งอาจได้รับการจัดส่งชุดเอกสารใหม่ภายใต้นโยบายการคืนสินค้า (การจัดส่งใหม่ — ไม่ใช่การคืนเพื่อขอเครดิต)",
      },
      {
