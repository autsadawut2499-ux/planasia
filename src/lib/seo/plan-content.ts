...
function spinContent(slug: string, v: MatrixVariables) {
  ...
  const closers = [
    ...
    "รองรับการปรับแบบเพิ่มเติมโดยช่างเขียนแบบมืออาชีพ พร้อมส่งไฟล์ทันทีหลังซื้อ",
...
function buildFaqs(v: MatrixVariables, slug: string): PlanFaq[] {
  ...
  const faqs: PlanFaq[] = [
    ...
    },
    {
      ...
      answer:
        "ได้ คุณสามารถติดต่อช่างเขียนแบบผู้สร้างสรรค์ผลงานผ่านหน้าโปรไฟล์เพื่อขอปรับแบบเพิ่มเติมตามที่ดินและงบประมาณจริง",
    },
    {
