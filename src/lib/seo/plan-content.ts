...
function spinContent(slug: string, v: MatrixVariables) {
  ...
  const intros = [
    ...
    `เลือกชมแบบบ้าน${spec} ที่ตอบโจทย์การอยู่อาศัยจริง จัดส่งชุดเอกสาร PDF ถึงที่อยู่ภายใน 2-3 วันทำการ`,
  ...
  const closers = [
    "ทุกแบบประทับตราชื่อผู้ซื้อเพื่อความปลอดภัย และจัดส่งชุดเอกสารรูปเล่มหลังชำระเงิน",
    "รองรับการปรับแบบเพิ่มเติมโดยสถาปนิกและนักออกแบบมืออาชีพ พร้อมจัดส่งชุดเอกสารหลังสั่งซื้อ",
    "เหมาะใช้เป็นแนวทางออกแบบและประเมินราคา — ควรให้ผู้มีใบอนุญาตท้องถิ่นรับรองก่อนก่อสร้างจริง",
    "มาพร้อมภาพพรีวิวและรายละเอียดสเปกครบถ้วน เลือกซื้อและสั่งจัดส่งชุดเอกสารได้ในไม่กี่คลิก",
  ];
  const h2s = [
...
function buildFaqs(v: MatrixVariables, slug: string): PlanFaq[] {
  ...
  const priceLine = v.budgetLabel
    ? `แบบบ้านในหมวดนี้อยู่ใน${v.budgetLabel} โดยราคาชุดเอกสารเริ่มต้นแสดงในแต่ละรายการ`
    : "ราคาชุดเอกสารแบบแปลน (PDF) แสดงชัดเจนในแต่ละรายการ และจัดส่งชุดเอกสารรูปเล่มหลังชำระเงิน";
  ...
  const faqs: PlanFaq[] = [
    ...
    },
    {
      ...
      answer:
        "ได้รับชุดเอกสาร PDF แปลนพิมพ์เขียวคุณภาพสูง หน่วยวัดระบบเมตร ประทับตราชื่อผู้ซื้อ จัดส่งถึงที่อยู่ภายใน 2-3 วันทำการ",
    },
    {
