...
const translations: Translations = {
  ...
  th: {
    ...
    "hero.subtitle":
      "เลือกชมคอลเลกชันแบบบ้านระดับมืออาชีพ ค้นหาแปลนที่ใช่ ซื้อได้ทันที และรับชุดเอกสารพร้อมก่อสร้าง",
    ...
    "pricing.feature.instantDownload": "จัดส่งชุดเอกสารรูปเล่มหลังชำระเงิน",
    ...
    "workflow.watermarkHint": "ตัวอย่างมีลายน้ำ — ชำระเงินเพื่อสั่งซื้อชุดเอกสาร",
    "workflow.paywallHint": "ชำระเงินเพื่อสั่งซื้อชุดเอกสาร PDF หรือ CAD แบบไม่มีลายน้ำ",
    "workflow.payToUnlock": "ชำระเงินเพื่อสั่งซื้อ",
    ...
    "workflow.plansReadyPaywall": "ชุดแบบแปลนพร้อมแล้ว — เลื่อนดูตัวอย่าง ชำระเงินเพื่อสั่งซื้อ",
    "workflow.autoListed": "ลงร้านแบบบ้านแล้ว (คนอื่นเห็นได้ คุณมองไม่เห็น)",
    "workflow.unlockedHint": "ชำระเงินเรียบร้อย — ดูแปลนชั้น สั่งซื้อชุดเอกสาร และลงร้านแบบบ้านเปิดใช้งานแล้ว",
    ...
    "payment.title": "สั่งซื้อชุดเอกสาร",
    "payment.desc": "ชำระเงินเพื่อจัดส่งชุดเอกสารคุณภาพเต็มจากผู้ขาย",
    "payment.payNow": "ชำระเงินและสั่งซื้อ",
    "payment.processing": "กำลังดำเนินการ...",
    "payment.failed": "ชำระเงินไม่สำเร็จ กรุณาลองใหม่",
    "download.readyPdf": "ชุดแบบ PDF พร้อมแล้ว — กดสั่งซื้อเพื่อจัดส่งชุดเอกสาร",
    ...
    "store.purchaseSuccess": "ชำระเงินสำเร็จ — กำลังจัดส่งชุดเอกสาร",
    "store.paymentPending":
      "ส่งการชำระเงินแล้ว — รอธนาคารยืนยัน ระบบจะยืนยันคำสั่งซื้อและจัดส่งชุดเอกสารให้อัตโนมัติ",
    ...
    "store.cartCheckoutSuccess": "ชำระเงินตะกร้าสำเร็จ — กำลังจัดส่งชุดเอกสาร",
