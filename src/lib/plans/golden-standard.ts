...
export function buildGoldenStandardContext(): string {
  ...
  return `GOLDEN STANDARD (DPT / Smart A TYPE E) — STRICT layout authority for all construction drawings:
...
- Sheet codes, index, scales, and discipline structure MUST match templates/cad/golden-standard.json
All user+AI outputs must match this DPT-aligned sheet structure for permit readiness.`;
}
