...
export const MATERIAL_GRADE_FACTORS: Record<string, number> = {
  ...
  precast: 1.14,
  "clay-brick": 0.9,
  "ceramic-porcelain": 0.98,
  "ceramic-tile": 0.98,
  "lvt-spc": 1.0,
  laminate: 1.06,
  "engineered-wood": 1.12,
  parquet: 1.18,
  "granite-marble": 1.24,
  granite: 1.24,
  "polished-concrete": 0.94,
  wood: 1.06,
  "concrete-roof-tile": 1.0,
  "ceramic-roof-tile": 1.1,
  "fiber-cement-roof": 0.96,
  "concrete-flat": 1.02,
  "metal-sheet": 0.9,
  "asphalt-shingle": 0.94,
  "clay-tile": 1.12,
  "polycarbonate-acrylic": 1.08,
};
